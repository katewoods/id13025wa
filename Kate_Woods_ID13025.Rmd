...
The Parking Tickets dataset was taken from the City of Toronto's Open Data Portal (https://open.toronto.ca/dataset/parking-tickets/). The CSV files were imported into R in the Rdata file "Kate_Woods_ID13025_data.Rdata" which can be found in the repository.
